...
class MatchingScoreCalculatorTest {
    ...
    void testGetMannerPriority_SameManner() {
        int result = calculator.getMannerPriority(5, 5, 16, 4);
    ...
    void testGetMannerPriority_DifferentManner() {
        int result = calculator.getMannerPriority(5, 1, 16, 4);
    ...
    void testGetTierRankPriority_SameTierAndRank() {
        int result = calculator.getTierRankPriority(Tier.GOLD, 4, Tier.GOLD, 4, 40, 4);
    ...
    void testGetTierRankPriority_DifferentTierAndRank() {
        int result = calculator.getTierRankPriority(Tier.GOLD, 1, Tier.SILVER, 2, 40, 4);
    ...
    void testGetPositionPriority_SameMainPosition() {
        int result = calculator.getPositionPriority(Position.TOP, Position.TOP, Position.MID, 3, 2, 1);
    ...
    void testGetPositionPriority_SubPositionMatch() {
        int result = calculator.getPositionPriority(Position.MID, Position.TOP, Position.MID, 3, 2, 1);
    ...
    void testGetPositionPriority_AnyPosition() {
        int result = calculator.getPositionPriority(Position.ANY, Position.JUNGLE, Position.MID, 50, 30, 10);
    ...
    void testGetMikePriority_SameMike() {
        int result = calculator.getMikePriority(Mike.AVAILABLE, Mike.AVAILABLE, 2);
        assertThat(result).isEqualTo(2);
    }
    ...
    void testGetMikePriority_DifferentMike() {
        int result = calculator.getMikePriority(Mike.AVAILABLE, Mike.UNAVAILABLE, 2);
        assertThat(result).isEqualTo(0);
    }
