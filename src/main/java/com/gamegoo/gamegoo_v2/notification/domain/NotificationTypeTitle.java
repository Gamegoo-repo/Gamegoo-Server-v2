...
public enum NotificationTypeTitle {
    ...
    FRIEND_REQUEST_RECEIVED(1, "님에게 친구 요청이 왔어요.", "/users/"),
    FRIEND_REQUEST_ACCEPTED(1, "님이 친구를 수락했어요.", null),
    FRIEND_REQUEST_REJECTED(1, "님이 친구를 거절했어요.", null),
    MANNER_LEVEL_UP(2, "매너레벨이 n단계로 올라갔어요!", "/mypage/review"),
    MANNER_LEVEL_DOWN(2, "매너레벨이 n단계로 떨어졌어요.", "/mypage/review"),
    MANNER_KEYWORD_RATED(3, "지난 매칭에서 n 키워드를 받았어요. 자세한 내용은 내 평가에서 확인하세요!", "/mypage/review"),
